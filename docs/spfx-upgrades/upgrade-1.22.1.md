# Upgrade project spfx-knowledgeagent-client-side-solution to v1.22.1
...
```sh
npm i -SE @microsoft/sp-dialog@1.22.1
```
...
```sh
npm i -SE @microsoft/sp-application-base@1.22.1
```
...
```sh
npm i -SE @microsoft/decorators@1.22.1
```
...
```sh
npm i -SE @microsoft/sp-core-library@1.22.1 @microsoft/sp-dialog@1.22.1 @microsoft/sp-application-base@1.22.1 @microsoft/decorators@1.22.1
npm i -DE @microsoft/sp-module-interfaces@1.22.1 @microsoft/eslint-plugin-spfx@1.22.1 @microsoft/eslint-config-spfx@1.22.1 @microsoft/spfx-web-build-rig@1.22.1 @microsoft/spfx-heft-plugins@1.22.1
npm dedupe
```
